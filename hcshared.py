...
# The salt_t is a fixed data-type so we can handle it here invaluable. The esalt field is not included in the blob, but we can add it to the dict as None for now and populate it later when we have the esalt data available. noted.
